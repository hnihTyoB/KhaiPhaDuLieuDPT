...
| :--- | :---: | :---: | :--- | :---: |
| **Nguyễn Chí Thịnh**<br>(Nhóm trưởng) | N22DCPT089 | [@hnihTyoB](https://github.com/hnihTyoB) | – Thiết kế kiến trúc học máy (trích xuất SIFT descriptors, gom cụm K-Means tạo Codebook).<br>– Cải tiến phân vùng Spatial Pyramid Matching (SPM 1x1 + 2x2) để lưu giữ cấu trúc không gian của địa danh.<br>– Huấn luyện bộ phân lớp SVM (Linear Kernel) và tối ưu hóa các siêu tham số.<br>– Lập trình file mã nguồn chính [landmark_sift_bovw.py](file:///d:/Python/Projects/KhaiPhaDuLieu/Nhom4_Project/landmark_sift_bovw.py). | 35% |
| **Huỳnh Thanh Trà** | N22DCPT097 | [@TraDeThuong](https://github.com/TraDeThuong) | – Lập trình bộ so khớp đặc trưng SIFT (BFMatcher + Lowe's ratio test) và lọc RANSAC loại bỏ outliers.<br>– Phát triển thuật toán ước lượng góc xoay (Orientation Histogram Voting) và tự động xoay ảnh bằng ma trận WarpAffine.<br>– Thiết kế Reference Cache và thuật toán tìm kiếm lai **FAST-SIFT** (kết hợp xác suất SVM và Cosine Similarity của BoVW 1x1) giúp tăng tốc gấp 26 lần.<br>– Lập trình file mã nguồn pipeline [sift_landmark_pipeline.py](file:///d:/Python/Projects/KhaiPhaDuLieu/Nhom4_Project/sift_landmark_pipeline.py). | 35% |
| **Tô Duy Hào** | N22DCPT025 | [@Shunnio](https://github.com/Shunnio) | – Thu thập, gán nhãn và tiền xử lý tập dữ liệu (dataset) 10 địa danh gồm 618 ảnh và thư mục ảnh test.<br>– Thiết lập và tối ưu hóa file Notebook [sift_landmark_colab.ipynb](file:///d:/Python/Projects/KhaiPhaDuLieu/Nhom4_Project/sift_landmark_colab.ipynb) chạy trên môi trường Colab (tự động hóa tải dataset/models từ Google Drive cá nhân).<br>– Biên soạn tài liệu báo cáo kỹ thuật, slide thuyết trình và tài liệu hướng dẫn bảo vệ đồ án [project_defense_guide.md](file:///C:/Users/USER/.gemini/antigravity-ide/brain/25d1648f-5860-41e6-b689-7fd05264a53f/project_defense_guide.md). | 30% |
